...
#$routes->get('/', 'ToDoList::index'); untuk mengakses "todolist" <--!!!
// $routes->get('/home', 'Home::index');

// Latihan Session Library
$routes->get('login', 'AsistenController::index');
$routes->match(['get', 'post'], 'login/check', [AsistenController::class, 'check']);
$routes->get('asisten/home', [Login::class, 'home']);
$routes->get('asisten/logout', [Login::class, 'logout']);
